...
rainbowifyCreate(mainTitleSpanList, 250, rainbowDone).observe(titlePage);
...
function rainbowifyCreate(spanList, delay = document.body.getAttribute(base), rainbowDone) {
