...
The swapLangCreate function will create an intersection observer that gives a fast typing effect to the title that switches between different languages.
...
swapLangCreate(isWorking).observe(motto);

// Word Array. Can be modified without the need to change constants
var wordArray = ["好きにしろ", "To Do As One Likes", "做你想要的", "делай что хочешь"];
